...
WebUI.setText(findTestObject('Object Repository/RecordSauceDemo/CheckoutSucces/input_Checkout_firstName'), 'Fach')

WebUI.setText(findTestObject('Object Repository/RecordSauceDemo/CheckoutSucces/input_Checkout_lastName'), 'That')

WebUI.setText(findTestObject('Object Repository/RecordSauceDemo/CheckoutSucces/input_Checkout_postalCode'), '123456')

WebUI.click(findTestObject('Object Repository/RecordSauceDemo/CheckoutSucces/input_Cancel_continue'))

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/RecordSauceDemo/CheckoutSucces/button_Finish'))
